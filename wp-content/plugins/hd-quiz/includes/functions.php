...
function hdq_get_results($quiz_settings)
{
	...
	<div class = "hdq_results_wrapper">
        ...
        echo ' - <span class = "hdq_result_percent"></span>';
			...
			<div class = "hdq_result_pass"><?php echo $pass_text; ?></div>
			<div class = "hdq_result_fail"><?php echo $fail_text; ?></div>
	<?php
...
------------------------------------------------------- */
function hdq_multiple_choice_text($question_number, $question, $quiz)
{
    require(dirname(__FILE__) . '/templates/default.php');
}
function hdq_multiple_choice_image($question_number, $question, $quiz)
{
    require(dirname(__FILE__) . '/templates/image.php');
}
function hdq_text_based($question_number, $question, $quiz)
{
    require(dirname(__FILE__) . '/templates/text.php');
}
function hdq_title($question_number, $question, $quiz)
{
